...
function StarshipDetails ({ route }) {
    ...
    return (
        <View style={styles.container}>
            <ScrollView>
                ...
                <Text style={styles.title}>{'Hyperdriven rating: '}{character.hyperdrive_rating}</Text>
                <Text style={styles.title}>{'MGLT: '}{character.MGLT}</Text>
